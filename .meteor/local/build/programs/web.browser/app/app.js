...
Template["resource_display"] = new Template("Template.resource_display", (function() {                                 // 45
  var view = this;                                                                                                     // 46
  return [ HTML.H5("Name: ", Blaze.View("lookup:display_employee_details.name", function() {                           // 47
    return Spacebars.mustache(Spacebars.dot(view.lookup("display_employee_details"), "name"));                         // 48
  })), "\n  ", HTML.H5("Role: ", Blaze.View("lookup:display_employee_details.role", function() {                       // 49
    return Spacebars.mustache(Spacebars.dot(view.lookup("display_employee_details"), "role"));                         // 50
  })), "\n  ", HTML.H5("Location: ", Blaze.View("lookup:display_employee_details.location", function() {               // 51
    return Spacebars.mustache(Spacebars.dot(view.lookup("display_employee_details"), "location"));                     // 52
  })), "\n  ", HTML.TABLE("\n  ", HTML.THEAD("\n    ", HTML.TH("Skill:"), "\n    ", HTML.TH("Level:"), "\n  "), "\n  ", HTML.TBODY("\n  ", Blaze.Each(function() {
    return Spacebars.call(Spacebars.dot(view.lookup("display_employee_details"), "skills"));                           // 54
  }, function() {                                                                                                      // 55
    return [ "\n    ", HTML.TR("\n      ", HTML.TD("\n        ", Blaze.View("lookup:name", function() {                // 56
      return Spacebars.mustache(view.lookup("name"));                                                                  // 57
    }), "\n      "), "\n      ", HTML.TD(Blaze.View("lookup:level", function() {                                       // 58
      return Spacebars.mustache(view.lookup("level"));                                                                 // 59
    })), "\n    "), "\n  " ];                                                                                          // 60
  }), "\n  "), "\n  ") ];                                                                                              // 61
}));                                                                                                                   // 62
                                                                                                                       // 63
Template.__checkName("resource_visualization");                                                                        // 64
Template["resource_visualization"] = new Template("Template.resource_visualization", (function() {                     // 65
  var view = this;                                                                                                     // 66
  return HTML.DIV({                                                                                                    // 67
    class: "bottom-panel"                                                                                              // 68
  }, HTML.Raw('\n      <div class="col-md-4" style="background-color: #8ecf88; height: 100%;">\n       stuff\n      </div>\n      '), HTML.DIV({
    class: "col-md-8",                                                                                                 // 70
    style: "background-color: #bae3b6 ; height: 100%"                                                                  // 71
  }, "\n        ", Spacebars.include(view.lookupTemplate("radarChart")), "\n      "), "\n  ");                         // 72
}));                                                                                                                   // 73
                                                                                                                       // 74
Template.__checkName("resource_list");                                                                                 // 75
Template["resource_list"] = new Template("Template.resource_list", (function() {                                       // 76
  var view = this;                                                                                                     // 77
  return HTML.TABLE({                                                                                                  // 78
    class: "hoverTable"                                                                                                // 79
  }, "\n      ", HTML.THEAD("\n        ", HTML.TH("\n          Name:\n        "), "\n        ", HTML.TH("\n          Team:\n        "), "\n        ", HTML.TH("\n          Role:\n        "), "\n        ", HTML.TH("\n          Office:\n        "), "\n        ", HTML.TH("\n          Location:\n        "), "\n      "), "\n      ", HTML.TBODY("\n        ", Blaze.Each(function() {
    return Spacebars.call(view.lookup("getEmployees"));                                                                // 81
  }, function() {                                                                                                      // 82
    return [ "\n          ", Spacebars.include(view.lookupTemplate("employee_row")), "\n        " ];                   // 83
  }), "\n      "), "\n  ");                                                                                            // 84
}));                                                                                                                   // 85
                                                                                                                       // 86
Template.__checkName("employee_row");                                                                                  // 87
Template["employee_row"] = new Template("Template.employee_row", (function() {                                         // 88
  var view = this;                                                                                                     // 89
  return HTML.TR({                                                                                                     // 90
    class: "employee_row"                                                                                              // 91
  }, "\n      ", HTML.TD("\n        ", Blaze.View("lookup:name", function() {                                          // 92
    return Spacebars.mustache(view.lookup("name"));                                                                    // 93
  }), "\n      "), "\n      ", HTML.TD("\n        ", Blaze.View("lookup:team", function() {                            // 94
    return Spacebars.mustache(view.lookup("team"));                                                                    // 95
  }), "\n      "), "\n      ", HTML.TD("\n        ", Blaze.View("lookup:role", function() {                            // 96
    return Spacebars.mustache(view.lookup("role"));                                                                    // 97
  }), "\n      "), "\n      ", HTML.TD("\n        ", Blaze.View("lookup:office", function() {                          // 98
    return Spacebars.mustache(view.lookup("office"));                                                                  // 99
  }), "\n      "), "\n      ", HTML.TD("\n       ", Blaze.View("lookup:location", function() {                         // 100
    return Spacebars.mustache(view.lookup("location"));                                                                // 101
  }), "\n      "), "\n    ");                                                                                          // 102
}));                                                                                                                   // 103
                                                                                                                       // 104
Template.__checkName("radarChart");                                                                                    // 105
Template["radarChart"] = new Template("Template.radarChart", (function() {                                             // 106
  var view = this;                                                                                                     // 107
